class Sorteo<T> {
    //Aquí, sorteo es una clase genérica que acepta un tipo T como parámetro.
    // Esto significa que al instanciar la clase, puedes especificar qué tipo de dato deseas utilizar.
    private numero?: T;
